...
<script type="text/javascript">
    ...
    jQuery(function () {
        jq("#get-patient-shr").click(function (){
            fnFetchShr();
        });
    });

    function fnDisplayLoadingSpinner(status) {
        if(status) {
    ...
    function fnFetchShr() {
        fnDisplayLoadingSpinner(true);
        jq("#pull-msgBox").text("Fetching...");
        jq.getJSON('${ ui.actionLink("kenyaemrIL", "shr/summaries", "fetchShrFromServer")}', {
            patient: ${ currentPatient.id }
        }).success(function (data) {
            fnDisplayLoadingSpinner(false);
            jq("#pull-msgBox").text("");
        }).fail(function (err, textStatus, errorThrown) {
            fnDisplayLoadingSpinner(false);
            jq("#pull-msgBox").text("There was an error fetching patient SHR. " + textStatus);
        });
    }
    ...
    <div id="content" class="container">
        ...
        <div id="show-content" class="container">
            ...
            <div class="dashboard clear">
                <div align="center" class="wait-loading"></div>
                <div class="text-wrap" align="center" id="pull-msgBox"></div>
                <table>
                    <tr>
                        <td>Last visit date: 01-04-2021</td>
                        <td>
                            <button id="get-patient-shr">Fetch</button>
                        </td>
                    </tr>
                </table>
