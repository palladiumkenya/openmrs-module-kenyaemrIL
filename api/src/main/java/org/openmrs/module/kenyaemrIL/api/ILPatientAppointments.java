...
//set appointment information
            ...
            Encounter lastFollowUpEncounter = ILUtils.lastEncounter(patient, Context.getEncounterService().getEncounterTypeByUuid("a0034eee-1940-4e35-847f-97537a35d05e"));
            ...
            for (Obs obs : lastFollowUpEncounter.getObs()) {
                ...
                if (obs.getConcept().getConceptId().equals(patientTCAConcept)) {    //set action code
                    appointmentInformation.setAppointment_note("TO COME BACK FOR A REFILL");
                }
                if (obs.getConcept().getConceptId().equals(patientTCAConcept)) {    //set action code
