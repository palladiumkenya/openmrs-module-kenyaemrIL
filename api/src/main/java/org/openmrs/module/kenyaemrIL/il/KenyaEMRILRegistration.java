 ...
 */
public class KenyaEMRILRegistration extends BaseOpenmrsMetadata implements Serializable {
    ...
    public KenyaEMRILRegistration() {
    }

    public KenyaEMRILRegistration(Integer messageId) {
