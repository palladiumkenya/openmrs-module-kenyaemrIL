 ...
 */
public class AcuteFebrileRashInfectionScreeningCalculation extends AbstractPatientCalculation {
	protected static final Log log = LogFactory.getLog(AcuteFebrileRashInfectionScreeningCalculation.class);
