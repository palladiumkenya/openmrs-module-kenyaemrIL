 ...
 */
public class AcuteHaemorrhagicFeverCalculation extends AbstractPatientCalculation {
    protected static final Log log = LogFactory.getLog(AcuteHaemorrhagicFeverCalculation.class);
